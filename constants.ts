...
export const OPENING_SCRIPT = `好的，感谢维克主持人！尊敬的各位领导、各位同事，大家上午好！我是本次盛典的AI主持人——小信。欢迎来到二零二五金发科技信息管理部年度颁奖！今晚，星光璀璨，我们将共同见证那些在过去一年里表现卓越的个人与团队。请大家调整呼吸，准备迎接属于我们的荣耀时刻！`;
...
export const AWARDS: Award[] = [
  {
    ...
    scripts: {
      preReveal: `盛典第一项，我们将颁发【优秀专员奖】。他们在各自的职能领域里深耕细作，是部门高效运转的坚实保障。`,
  ...
  },
  {
    ...
    scripts: {
      ...
      reveal: `获奖者是：服务管理组的何柳琴。你在工作中展现出的非凡担当与卓越贡献，大家有目共睹，你是我们的榜样！掌声有请盛佳哥上台为你颁奖！`,
  ...
  },
  {
    ...
    scripts: {
      ...
      reveal: `他们分别是：啊爸开发组的余泓希、周震宇。你们用一航航代码筑起系统的基石，技术精湛，攻坚克难。有请维维哥上台为他们颁奖！`,
  ...
  },
  {
    ...
    scripts: {
      preReveal: `他们是幕后的英雄，守护着数字世界的基石。接下来颁发【基础设施先锋奖】。`,
  ...
  },
  {
    ...
    scripts: {
      preReveal: `综合素质过硬，业绩表现卓越，下面颁发【部门优秀员工大奖】。`,
