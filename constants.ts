...
export const OPENING_SCRIPT = `好的，感谢维克主持人！尊敬的各位领导、各位同事，大家上午好！我是本次颁奖环节的AI主持人——小信。欢迎来到二零二五金发科技信息管理部年度颁奖！今天我们将共同见证那些在过去一年里表现卓越的个人与团队。请大家调整呼吸，准备迎接属于我们的荣耀时刻！`;
...
export const AWARDS: Award[] = [
  {
    ...
    scripts: {
      preReveal: `颁奖环节第一项，我们将颁发【优秀专员奖】。他们在各自的职能领域里深耕细作，是部门高效运转的坚实保障。`,
